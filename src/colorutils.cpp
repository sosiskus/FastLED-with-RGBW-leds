...
void fill_gradient_RGBW(CRGBW *leds,
                        ...
                        uint16_t endpos, CRGBW endcolor)
{
    ...
    saccum87 gdistance87;
    saccum87 bdistance87;
    saccum87 wdistance87;

    rdistance87 = (endcolor.r - startcolor.r) << 7;
    gdistance87 = (endcolor.g - startcolor.g) << 7;
    bdistance87 = (endcolor.b - startcolor.b) << 7;
    wdistance87 = (endcolor.w - startcolor.w) << 7;
    ...
    saccum87 gdelta87 = gdistance87 / divisor;
    saccum87 bdelta87 = bdistance87 / divisor;
    saccum87 wdelta87 = wdistance87 / divisor;
    ...
    accum88 g88 = startcolor.g << 8;
    accum88 b88 = startcolor.b << 8;
    accum88 w88 = startcolor.w << 8;
    for (uint16_t i = startpos; i <= endpos; ++i)
    {
        leds[i] = CRGBW(r88 >> 8, g88 >> 8, b88 >> 8, w88 >> 8);
        r88 += rdelta87;
        g88 += gdelta87;
        b88 += bdelta87;
        w88 += wdelta87;
...
void fill_gradient_RGBW(CRGBW *leds, uint16_t numLeds, const CRGBW &c1, const CRGBW &c2)
{
    uint16_t last = numLeds - 1;
    fill_gradient_RGBW(leds, 0, c1, last, c2);
}
